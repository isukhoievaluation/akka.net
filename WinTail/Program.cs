...
namespace WinTail
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //IActorRef fackeActor = MyActorSystem.ActorOf(fakeActorProps, "fackeActor");

            Props consoleWriterProps = Props.Create<ConsoleWriterActor>();
            IActorRef consoleWriterActor = MyActorSystem.ActorOf(consoleWriterProps, "consoleWriterProps");
